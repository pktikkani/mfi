...
def get_homepage():
    return Main(
        Div(cls="flex flex-col items-center justify-center relative")(
            Img(cls="max-w-lg mx-auto md:max-h-auto")(src='static/img/meditation.png'),
            H1(cls="absolute text-center text-4xl top-1 md:text-5xl md:top-10 md:mt-14 md:-ml-12")("Meditate for India"),
            Div(cls="absolute flex flex-col items-center justify-center mt-34")(
                P(cls="text-xl text-teal-800 text-center font-sans max-w-prose leading-loose flex flex-col")
                    (
                    Span(cls="block")("A Global 24-Hour Immersion in"),
                    Span(cls="block")("Meditation, Pranayama and Chanting"),
                    Span(cls="block font-bold")("21st June 2025 From: time")
                ),
            ),
            Button(
                cls="bg-[#1DB0CD] hover:bg-[#19a0bb] text-white font-medium py-3 px-6 rounded-md transition duration-300 h-12 flex items-center justify-center;")
